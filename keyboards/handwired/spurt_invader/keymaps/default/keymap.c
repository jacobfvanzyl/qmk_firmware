...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //------------------------------------------------------------------------------                ----------------------------------------------------------------------------
    KC_A,   KC_S,   MT(MOD_LALT,KC_D),    MT(MOD_LGUI,KC_F),    KC_G,  	                          KC_H,   KC_J,   KC_K,  KC_L,  KC_SEMICOLON,
  //------------------------------------------------------------------------------                ----------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------------      -----------------------------------------------------
    KC_TAB,     KC_MUTE,    KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,    TO(4),                                  KC_F5,  KC_F6,   KC_F7,     KC_F8,   KC_ENTER,
  //---------------------------------------------------------------------------------------------------     -----------------------------------------------------
    KC_CAPS,    KC_KP_ASTERISK, KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP,   /*TD(RESET_MCU)*/ QK_BOOT,          KC_F1,  KC_F2,   KC_F3,     KC_F4,   KC_DELETE,
  //---------------------------------------------------------------------------------------------------     -----------------------------------------------------
	  OSM(MOD_LSFT),    TO(0),                                                                                KC_NO,    KC_LALT
  ),
